    ...
    <section class="add-data">
      <div class="container">
        <div class="row gy-5">
          ...
          <form action="add-pasien-proses.php" method="post">
            <div class="row gy-5">
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="nama-pasien" class="form-label">Nama Pasien <span style="color: red;">*</span></label>
                  <input type="text" class="form-control" id="nama-pasien" placeholder="Nama Pasien" required name="nama">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="no-wa" class="form-label">No WhatsApp <span style="color: red;">*</span></label>
                  <input type="number" class="form-control" id="no-wa" placeholder="WA Pasien/Perawat" required name="no_wa">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="no-ruangan" class="form-label">No Ruangan <span style="color: red;">*</span></label>
                  <input type="number" class="form-control" id="no-ruangan" placeholder="Nomor Ruangan" required name="no_ruangan">
                </div>
              </div>
              <div class="col-lg-6">
                <div class="mb-3">
                  <label for="no-bed" class="form-label">No Bed <span style="color: red;">*</span></label>
                  <input type="number" class="form-control" id="no-bed" placeholder="Nomor Bed" required name="no_bed">
                </div>
              </div>
              <div class="col-lg-6">
